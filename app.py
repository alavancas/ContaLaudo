...
def magic_link():
    if request.method == 'POST':
        ...
        try:
            ...
            # Usando o método correto para esta versão do Supabase
            print("Chamando Supabase sign_in_with_magic_link...", file=sys.stderr)
            res = supabase.auth.sign_in_with_magic_link(
                email=email,
